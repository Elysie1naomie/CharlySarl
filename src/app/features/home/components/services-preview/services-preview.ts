  ...
  services = [
    {
      ...
      description: 'Tables, chaises, buffets et meubles de rangement conçus selon vos dimensions et vos goûts.',
    },
    {
      ...
      title: 'Cuisines',
      description: 'Cuisines entièrement personnalisées, alliant fonctionnalité et esthétique haut de gamme.',
    },
    {
      icon: `<svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M4 6h16M4 10h16M4 14h16M4 18h16"/></svg>`,
      title: 'Dressings',
      description: 'Dressings et placards sur mesure optimisant chaque centimètre de votre espace.',
    },
    {
      icon: `<svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"/></svg>`,
      title: 'Bibliothèques',
      description: 'Bibliothèques et étagères sur mesure, du sol au plafond, pour sublimer vos intérieurs.',
    },
    {
      ...
      title: 'Restauration',
      description: 'Restauration et rénovation de meubles anciens avec respect des techniques traditionnelles.',
    },
    {
      icon: `<svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 3H5a2 2 0 00-2 2v4m6-6h10a2 2 0 012 2v4M9 3v18m0 0h10a2 2 0 002-2V9M9 21H5a2 2 0 01-2-2V9m0 0h18"/></svg>`,
      title: 'Agencement intérieur',
      description: 'Conception et réalisation complète de l\'agencement de vos espaces de vie et professionnels.',
    },
  ];
}
