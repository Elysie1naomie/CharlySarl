  ...
  services = [
    {
      ...
      description: 'Tables, chaises, buffets et meubles de rangement fabriqués selon vos dimensions et vos goûts.',
    },
    {
      ...
      description: 'Cuisines fabriquées sur mesure selon votre espace et votre budget, pour un résultat fonctionnel et solide.',
    },
    {
      ...
      description: 'Dressings et placards sur mesure pour optimiser chaque espace de votre maison.',
    },
    {
      icon: `<svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"/></svg>`,
      title: 'Bibliothèques et étagères',
      description: 'Bibliothèques et étagères sur mesure, du sol au plafond, pour bien ranger et décorer votre intérieur.',
    },
    {
      ...
      description: 'On remet en état vos vieux meubles avec soin, en respectant leur style et leur histoire.',
    },
    {
      ...
      description: 'On prend en charge l\'aménagement complet de votre maison, bureau ou commerce à Bafoussam et dans la région.',
    },
  ];
}
